...
/* ============================================================
   Luxury App Splash Screen — Mamou's Accessories

   S'affiche automatiquement au premier chargement du site
   (ou rafraîchissement) pour offrir une expérience "Maison de Luxe".
   Transition fondu de sortie fluide (Fade out 700ms).
   ============================================================ */
...
export function SplashScreen() {
  ...
  return (
    <div
      className={`fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-[#F1ECE3] overflow-hidden select-none transition-opacity duration-700 ease-out ${
        fadingOut ? "opacity-0 pointer-events-none" : "opacity-100"
      }`}
    >
      {/* Halo lumineux ambré/doré en arrière-plan */}
      <div
        className="absolute w-80 h-80 rounded-full bg-[radial-gradient(circle,rgba(185,121,62,0.18)_0%,rgba(241,236,227,0)_70%)] pointer-events-none"
      ...
      <div className="relative z-10 flex flex-col items-center gap-7 px-4">
        ...
        <div className="relative flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-b from-[#FAF7F2] to-[#EBE4D8] shadow-[0_8px_30px_rgb(185,121,62,0.15)] border border-[#B9793E]/25">
          <svg
        ...
        <div className="relative w-48 sm:w-56 h-[2px] bg-[#B9793E]/15 rounded-full overflow-hidden mt-1">
          <div
            ...
            style={{
              animation: "mamou-shimmer-bar 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite",
            }}
          />
        </div>
      </div>
